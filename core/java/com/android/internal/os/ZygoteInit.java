...
public class ZygoteInit {
    ...
    private static boolean startSystemServer()
        ...
        String args[] = {
            "--setuid=1000",
            "--setgid=1000",
            "--setgroups=1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1018,1021,1032,3001,3002,3003,3006,3007,3009,39", // 39 is video in sailfishos mako/hammerhead, required for input: EventHub needs to open /dev/input/event* and they are in group video
